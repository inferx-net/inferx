ARCH := ${shell uname -m}
PLATFORM_VERSION ?= v0.2.5beta1
DB_VERSION ?= v0.2.5beta1
DASHBOARD_VERSION ?= v0.2.5beta1
RUNTIME_VERSION ?= v0.2.5beta1
NA_VERSION ?= v0.2.5beta1
RUNMODEL_VERSION ?= v0.2.5beta1
SPDK_VERSION ?= v0.2.5beta1
